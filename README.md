...
| `production-soak-governor` | Generic production-like 24h/long-run validation with real readiness, non-mock prechecks, traffic, lifecycle runners, product-gap blocking, SCM, CI/CD, and final evidence. |
