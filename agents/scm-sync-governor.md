...
- Sandbox command: prefer `$OCTOPUS_AGENTOPS_HOME/bin/octopus-sandbox` for inspections and portable checks. If the environment variable is not set, use `/Users/wangyejing/github/octopus-agentops/bin/octopus-sandbox` when it exists; otherwise ask the user for the platform path before creating any temporary script.
...
Before sync, commit, or push, run and summarize through the platform sandbox:

```bash
"${OCTOPUS_AGENTOPS_HOME:-${AGENT_OCTOPUS_TOOLKIT_HOME:-/Users/wangyejing/github/octopus-agentops}}/bin/octopus-sandbox" git-inspect --cwd .
```

If branch ambiguity exists, include refs:

```bash
"${OCTOPUS_AGENTOPS_HOME:-${AGENT_OCTOPUS_TOOLKIT_HOME:-/Users/wangyejing/github/octopus-agentops}}/bin/octopus-sandbox" git-inspect --cwd . --include-refs
```
...
```bash
"${OCTOPUS_AGENTOPS_HOME:-${AGENT_OCTOPUS_TOOLKIT_HOME:-/Users/wangyejing/github/octopus-agentops}}/bin/octopus-sandbox" git-commit-check --cwd .
```
...
```bash
"${OCTOPUS_AGENTOPS_HOME:-${AGENT_OCTOPUS_TOOLKIT_HOME:-/Users/wangyejing/github/octopus-agentops}}/bin/octopus-sandbox" git-conflicts --cwd .
```
